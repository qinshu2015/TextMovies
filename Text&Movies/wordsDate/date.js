var local_Date = [
  ...
  },
  {
    ...
    author: "猫是猫的猫",
    dataTime: '24time',
    detail: "“对于绝大多数的非经济学专业大众而言（经济学相关专业硕士学历以上），人们所接触到的经济学都是初级微观经济学。所谓的初级微观经济学，对于经济问题的”画法“就是一种”简笔素描“。比如，晋毕卓更是感叹“右手持酒杯，左手持蟹螯，拍浮酒船中，便足了一生矣。”漫漫人生长路，美食与爱岂可辜负？于是作为一个吃货，突然也很想回味一下属于我的味蕾记忆。记忆中的秋蟹，是家人的味道，弥漫着浓浓的亲情。\n\n是谁来自山川湖海，却囿于昼夜，厨房与爱？ 是母亲，深思熟虑，聪明耐心。吃蟹前，总会拿出几件，现实中影响需求量的因素绝不止价格这一种，因此我们可以认为此不疲。告诉我们螃蟹至寒，需要佐以姜茶以祛寒，在配备的米醋小碟里，亦添入姜丝与紫苏，前者驱寒后者增香。泡好菊花茶求量的因素绝不止价格这。",
    postId: 1
  },
  {
    date: 'jep 23 2016',
...
module.exports={
  //local_Date接收定义的变量，postlist传递给需要调用的地方
  postlist: local_Date
}